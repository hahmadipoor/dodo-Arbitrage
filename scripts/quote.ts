...
const provider = new ethers.JsonRpcProvider("https://mainnet.infura.io/v3/6000068b86d54cc99d7adca1015120c5");
...
const quoter=new ethers.Contract(QUOTER_ADDRESS, quoter1Abi, provider);
const quoter2=new ethers.Contract(QUOTER_ADDRESS2, quoter2Abi, provider);
...
const main= async() =>{
    ...
    console.log("amount out from Quoter1", ethers.formatUnits(quote2.amountOut.toString(), 6));
